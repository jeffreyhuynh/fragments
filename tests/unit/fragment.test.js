...
describe('Fragment class', () => {
  ...
  describe('Fragment()', () => {
    ...
    test('created and updated are optional', () => {
      ...
      expect(fragment.created).toEqual(currTime);
      expect(fragment.updated).toEqual(currTime);
    });
  ...
  describe('save(), getData(), setData(), byId(), byUser(), delete()', () => {
    ...
    test('byUser(), delete() must have valid args', () => {
      expect(async () => await Fragment.byUser()).rejects.toThrow();
      expect(async () => await Fragment.byUser(1)).rejects.toThrow();
